<?php
/**
 * File:        /admin/core/classes/Mail.php
 *
...
class Mail
{
	...
	(
		...
		$smtp = Json::decode($conf['mail_smtp']);
	...
	public function Attach($files)
	{
		...
		if (isset($files['name']) AND ! empty($files['name'][0]))
		{
			...
			if (count($files['name']) > $conf['mail_file_col']) {
	...
	{
		global $conf, $lang, $tm, $api, $global;
