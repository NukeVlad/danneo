<?php
/**
 * File:        /admin/mod/catalog/mod.widget.php
 *
...
if (in_array($WORKMOD, $realmod))
{
	if (in_array($WORKMOD, $ADMIN_PERM_ARRAY) OR in_array($ADMIN_ID, $CHECK_ADMIN['admid']))
	{
		...
		// Orders
		$order = $db->fetchrow($db->query("SELECT COUNT(oid) AS total FROM ".$basepref."_".$WORKMOD."_order"));
		...
		echo '<div class="widget">
					...
					<ul>
						...
						<li>'.$lang['all_goods'].' — '.$total['total'].'</li>
						<li>'.$lang['order_total'].' — '.$order['total'].'</li>
