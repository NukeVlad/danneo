...
global $conf, $lang, $ye, $mo, $ro, $da;

$bc = null;
$lang['block_down_calendar'] = isset($lang['block_down_calendar']) ? $lang['block_down_calendar'] : 'Down calendar';

/**
 * Настройки
 */
$bs = array(
	'blockname' => $lang['block_down_calendar'],
	'mod' => array(
		'lang'    => 'block_mods',
		'form'    => 'text',
		'value'   => 'down',
