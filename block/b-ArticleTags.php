...
$tags = array();
$bc = $key = $tagword = null;
$lang['block_article_tags'] = isset($lang['block_article_tags']) ? $lang['block_article_tags'] : 'Article tags';

/**
 * Настройки
 */
$bs = array(
	'blockname' => $lang['block_article_tags'],
	'mod' => array(
		'lang'    => 'block_mods',
		'form'    => 'text',
		'value'   => 'article',
...
if (
	...
	$tncol = (isset($bs['col']) AND ! empty($bs['col'])) ? $bs['col'] : 10;
	$inq = $db->query("SELECT * FROM ".$basepref."_".$bs['mod']."_tag ORDER BY tagrating DESC LIMIT ".$tncol, $config['cachetime'], $bs['mod']);
