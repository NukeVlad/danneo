<?php
/**
 * File:        /core/classes/sms/SMSRU.php
 *
...
class SMSRU
{
    ...
    public function __construct()
	{
		...
		if (isset($config['smsru_auth']) AND $config['smsru_auth'] == 'api_id')
		{
			$this->default = array(
		...
		{
			$login = isset($config['smsru_login']) ? $config['smsru_login'] : '';
			$password = isset($config['smsru_password']) ? hash('sha512', $config['smsru_password'].$this->token) : '';
